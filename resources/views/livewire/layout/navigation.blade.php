...
<nav x-data="{ open: false }" class="border-b border-gray-100 bg-slate-500 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center shrink-0">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" wire:navigate  class="rounded-md px-3 py-2 text-white ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                        {{ __('Suas Notícias') }}
                    </x-nav-link>
                </div>
            </div>
